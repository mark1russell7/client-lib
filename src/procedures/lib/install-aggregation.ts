 ...
 */
export const cloneMissingPackageAggregation: AggregationDefinition = {
  $proc: ["client", "chain"],
  input: {
    steps: [
 ...
 */
export const installSinglePackageAggregation: AggregationDefinition = {
  $proc: ["client", "chain"],
  input: {
    steps: [
      // pnpm install
 ...
 */
export const libInstallAggregation: AggregationDefinition = {
  $proc: ["client", "chain"],
  input: {
    steps: [
