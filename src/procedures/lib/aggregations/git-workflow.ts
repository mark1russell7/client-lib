 ...
 */
export const gitCommitAndPushAggregation: AggregationDefinition = {
  $proc: ["client", "chain"],
  input: {
    steps: [
      // Stage all changes
 ...
 * Used by: lib.new
 */
export const gitInitWorkflowAggregation: AggregationDefinition = {
  $proc: ["client", "chain"],
  input: {
    steps: [
 ...
 * Used by: lib.pull
 */
export const gitPullAggregation: AggregationDefinition = {
  $proc: ["client", "chain"],
  input: {
    steps: [
      {
